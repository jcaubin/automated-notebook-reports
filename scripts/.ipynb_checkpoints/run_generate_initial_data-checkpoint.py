...
project_dir = os.path.dirname(os.path.abspath(__file__))  # Get the absolute path of the current script (in scripts folder)
data_folder = os.path.join(project_dir, '..', 'data')    # Go up one level and add the 'data' folder
